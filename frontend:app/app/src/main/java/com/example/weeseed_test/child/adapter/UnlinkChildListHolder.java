...
public class UnlinkChildListHolder extends RecyclerView.ViewHolder implements View.OnClickListener{
    ...
    public UnlinkChildListHolder(@NonNull View itemView, ItemClickListener itemClickListener) {
        super(itemView);
